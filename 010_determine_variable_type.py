...
print(f"Data type of var: boolean_value is : {boolean_value_datatype}")

character_datatype = type(ch)
print(f"Data type of var: ch is : {character_datatype}") # Characters in python are treated as strings of length 1, like in JS.